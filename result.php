...
<body>
    ...
    <div class="result">
        ...
        <form action="" method="post">
            <p>USN No</p>
            <input type="text" name="usn" placeholder="Enter your USN number" maxlength="10" style="text-transform: uppercase" pattern="[0-9]{1}[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{3}" required>
            <p>Password</p>
            <input type="password" name="password" placeholder="Enter your password" required>
            <input type="submit" name="" value="Get Your Result">
            <a href="contact.php">Apply For New Admmision.....</a><br>
            <a href="about.php">Can't Find The Details?</a>
        </form>
    </div>
