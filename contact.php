...
<body>
    ...
    <div class="container">
        ...
        <form action="contact.php" method="post">
            ...
            <input type="tel" name="age" id="age" minlength="2" maxlength="2" pattern="[0-9]{2}" placeholder="Enter your Age" required>


            <input type="email" name="email" id="email" placeholder="Enter your Email" required>
            <input type="tel" name="phone" id="phone_no" minlength="10" maxlength="10" pattern="[0-9]{10}" pattern="[0-9]{10}" placeholder="Enter your Number" required >
