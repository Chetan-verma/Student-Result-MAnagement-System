    ...
    <div class="container my-4">
        ...
        <form action="sinsert.php" method="POST" class="row g-3">
            ...
            <div class="col-6 my-1 mb-3">
                ...
                <input type="tel" name="number" class="form-control" id="number" minlength="10" maxlength="10" pattern="[0-9]{10}"
            ...
            <div class="col-5 my-1 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="usn" style="text-transform: uppercase" class="form-control" maxlength="10" pattern="[0-9]{1}[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{3}"
