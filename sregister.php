        ...
        <form action="sregister.php" method="post">
            <div class="user-details">
                ...
                <div class="input-box">
                    ...
                    <input type="tel" placeholder="Enter Your Phone number" name="number" minlength="10" maxlength="10" pattern="[0-9]{10}"
                        required>
                </div>
                <div class="input-box">
                ...
                <div class="input-box">
                    ...
                    <input type="tel" placeholder="Enter Your Usn Id (1VK)" name="usn" minlength="10" maxlength="10" pattern="[0-9]{1}[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{3}"
                        required>
                </div>
                <div class="input-box">
