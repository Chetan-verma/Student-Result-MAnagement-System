            ...
            <ul>
                ...
                <li><a href="sview.php">Student_Details</a>
                    <ul>
                        ...
                        <a href="femalestu.php">Female Students</a>
        ...
        <form action="addresult.php" method="POST" class="row g-3">
            ...
            <div class="col-4 my-1 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="tel" name="usn" style="text-transform: uppercase" class="form-control" maxlength="10" pattern="[0-9]{1}[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{3}
            ...
            <div class="col-md-4 my-1 mb-3">
                ...
                <input type="tel" placeholder="1st Subject Marks" name="sub1" minlength="1" maxlength="2" pattern="[0-9]{2}" class="form-control" required>
            </div>

            <div class="col-md-4 my-1 mb-3">
                <label for="inputSub_Name" class="form-label">Subject 2</label>
                <input type="tel" placeholder="2nd Subject Marks" name="sub2" minlength="1" maxlength="2" pattern="[0-9]{2}"
                    class="form-control" required>
            </div>

            <div class="col-md-4 my-1 mb-3">
                <label for="inputSub_Name" class="form-label">Subject 3</label>
                <input type="tel" placeholder="3rd Subject Marks" name="sub3" minlength="1" maxlength="2" pattern="[0-9]{2}"
                    class="form-control" required>
            </div>

            <div class="col-md-4 my-1 mb-3">
                <label for="inputSub_Name" class="form-label">Subject 4</label>
                <input type="tel" placeholder="4th Subject Marks" name="sub4" minlength="1" maxlength="2" pattern="[0-9]{2}"
                    class="form-control" required>
            </div>

            <div class="col-md-4 my-1 mb-3">
                <label for="inputSub_Name" class="form-label">Subject 5</label>
                <input type="tel" placeholder="5th Subject Marks" name="sub5" minlength="1" maxlength="2" pattern="[0-9]{2}"
                    class="form-control" required>
            </div>

            <div class="col-md-4 my-1 mb-3">
                <label for="inputSub_Name" class="form-label">Subject 6</label>
                <input type="tel" placeholder="6th Subject Marks" name="sub6" minlength="1" maxlength="2" pattern="[0-9]{2}"
                    class="form-control" required>
            </div>
